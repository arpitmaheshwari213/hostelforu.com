<%-- 
    Document   : HostelerLogin
    Created on : 20 Jul, 2016, 4:58:55 PM
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <div class="col-4" style="background-image:url('Images/BgTest9.jpg');background-size:100% auto;color:white;">
             <h2>Hosteler LogIn to Get exciting Offers on Hostel bookings in Kota</h2>
             
             <form method="post" action="HostelerLoginProcess.jsp" id="formLogin" onsubmit="return isFormValid()">
                 <p>Already a member of our community please LogIn </p>
                  Email-id<br><input type="text" name="hosteleremail" id="hosteleremail" placeholder="Yourname@email.com" ></input>
               <br><br>
